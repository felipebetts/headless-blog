...
thumbnailUrl: /images/posts/como-testar-com-cypress/thumbnail.png
tags: ['code', 'tutorial']
---
...
3. O Cypress será aberto em uma nova janela. Selecione a pasta cypress/integration e delete os exemplos de teste que vêm por padrão.
