  ...
  return (
    <>
      <button
        ...
        id="theme-toggle"
        type="button"
        className="ml-2 rounded-md bg-white dark:bg-slate-800 p-1 text-slate-400 dark:hover:text-indigo-700 hover:text-black  focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800"
      >
        {colorTheme === 'dark' ? (
